...
const designProcess = [
  { step: "01", title: "Free Site Visit", text: "We visit your property, discuss your requirements and take measurements. Whether it is a new driveway, patio or garden transformation, we assess the site and provide honest advice." },
  { step: "02", title: "Detailed Quote", text: "You receive a clear, written quote with no hidden costs. We explain the materials, timeline and process so you know exactly what to expect before any work begins." },
  { step: "03", title: "Preparation & Groundwork", text: "Michael and the team begin with thorough preparation — excavation, sub-base laying, drainage and levelling. This is the foundation of every quality installation." },
  { step: "04", title: "Installation", text: "Whether it is block paving, Indian stone, fencing or turfing, our experienced team installs everything to the highest standard using quality materials sourced from trusted suppliers." },
  { step: "05", title: "Finishing Touches", text: "We complete the project with careful attention to detail — jointing, sealing, edging and a thorough clean-up. We do not leave until the job is finished properly." },
  { step: "06", title: "Final Walkthrough", text: "We walk you through the completed project to make sure you are completely satisfied. We are not finished until you are happy with every detail." },
];
