...
/* All project images from Facebook portfolio */
const projectImages = [
  { src: "/images/portfolio/project-02.jpg", title: "Garden Clearance", location: client.basedIn },
  { src: "/images/portfolio/project-03.jpg", title: "Hedge Trimming", location: client.basedIn },
  { src: "/images/portfolio/project-04.jpg", title: "New Fencing", location: client.basedIn },
  { src: "/images/portfolio/project-05.jpg", title: "Lawn Care", location: client.basedIn },
  { src: "/images/portfolio/project-06.jpg", title: "Pruning & Shaping", location: client.basedIn },
  { src: "/images/portfolio/project-07.jpg", title: "Garden Maintenance", location: client.basedIn },
  { src: "/images/portfolio/project-08.jpg", title: "Fence Repair", location: client.basedIn },
  { src: "/images/portfolio/project-09.jpg", title: "Patio Clearance", location: client.basedIn },
  { src: "/images/portfolio/project-10.jpg", title: "Planting Scheme", location: client.basedIn },
  { src: "/images/portfolio/project-11.jpg", title: "Garden Rescue", location: client.basedIn },
  { src: "/images/portfolio/project-12.jpg", title: "Hedge Reduction", location: client.basedIn },
  { src: "/images/portfolio/project-13.jpg", title: "Fence Installation", location: client.basedIn },
  { src: "/images/portfolio/project-14.jpg", title: "Garden Tidy-Up", location: client.basedIn },
  { src: "/images/portfolio/project-15.jpg", title: "Lawn Mowing", location: client.basedIn },
  { src: "/images/portfolio/project-16.jpg", title: "Tree Pruning", location: client.basedIn },
  { src: "/images/portfolio/project-17.jpg", title: "Garden Clearance", location: client.basedIn },
  { src: "/images/portfolio/project-18.jpg", title: "New Borders", location: client.basedIn },
  { src: "/images/portfolio/project-19.jpg", title: "Overgrown Garden Rescue", location: client.basedIn },
  { src: "/images/portfolio/project-20.jpg", title: "Patio & Planting", location: client.basedIn },
  { src: "/images/portfolio/project-21.jpg", title: "Hedge Trimming", location: client.basedIn },
  { src: "/images/portfolio/project-22.jpg", title: "Garden Maintenance", location: client.basedIn },
  { src: "/images/portfolio/project-23.jpg", title: "Fencing & Gates", location: client.basedIn },
  { src: "/images/portfolio/project-24.jpg", title: "Shrub Shaping", location: client.basedIn },
  { src: "/images/portfolio/project-25.jpg", title: "Garden Clearance", location: client.basedIn },
  { src: "/images/portfolio/project-26.jpg", title: "Lawn Treatment", location: client.basedIn },
  { src: "/images/portfolio/project-27.jpg", title: "Hedge Cutting", location: client.basedIn },
  { src: "/images/portfolio/project-28.jpg", title: "Fence Panels", location: client.basedIn },
  { src: "/images/portfolio/project-29.jpg", title: "Garden Rescue", location: client.basedIn },
  { src: "/images/portfolio/project-30.jpg", title: "Seasonal Planting", location: client.basedIn },
  { src: "/images/portfolio/project-31.jpg", title: "Garden Maintenance", location: client.basedIn },
  { src: "/images/portfolio/project-32.jpg", title: "Pruning & Clearing", location: client.basedIn },
  { src: "/images/portfolio/project-33.jpg", title: "New Fencing", location: client.basedIn },
  { src: "/images/portfolio/project-34.jpg", title: "Garden Tidy-Up", location: client.basedIn },
  { src: "/images/portfolio/project-35.jpg", title: "Hedge Trimming", location: client.basedIn },
  { src: "/images/portfolio/project-36.jpg", title: "Garden Clearance", location: client.basedIn },
  { src: "/images/portfolio/project-37.jpg", title: "Lawn Care", location: client.basedIn },
  { src: "/images/portfolio/project-38.jpg", title: "Fence Repair", location: client.basedIn },
  { src: "/images/portfolio/project-39.jpg", title: "Planting & Beds", location: client.basedIn },
  { src: "/images/portfolio/project-40.jpg", title: "Garden Rescue", location: client.basedIn },
  { src: "/images/portfolio/project-41.jpg", title: "Hedge Reduction", location: client.basedIn },
  { src: "/images/portfolio/project-42.jpg", title: "Garden Maintenance", location: client.basedIn },
  { src: "/images/portfolio/project-43.jpg", title: "Tree Pruning", location: client.basedIn },
  { src: "/images/portfolio/project-44.jpg", title: "Fence Installation", location: client.basedIn },
  { src: "/images/portfolio/project-45.jpg", title: "Garden Clearance", location: client.basedIn },
  { src: "/images/portfolio/project-46.jpg", title: "Lawn Mowing", location: client.basedIn },
  { src: "/images/portfolio/project-47.jpg", title: "Shrub Shaping", location: client.basedIn },
  { src: "/images/portfolio/project-48.jpg", title: "Garden Tidy-Up", location: client.basedIn },
  { src: "/images/portfolio/project-49.jpg", title: "Hedge Trimming", location: client.basedIn },
  { src: "/images/portfolio/project-50.jpg", title: "Garden Maintenance", location: client.basedIn },
];
    ...
    <InnerPageLayout>
      ...
      >
        <Image
          ...
          alt="Portfolio — Garden Maintenance & Landscaping"
          fill
      ...
      <section style={{ background: "#f7f6f3" }} className="pt-16 pb-6 md:pt-20 md:pb-8">
        <div className="container-custom text-center">
          ...
          >
            Driveways, patios, fencing and landscaping, fencing and landscaping projects across {client.basedIn}
          </p>
        </div>
      </section>
        ...
        <div className="container-custom">
          <div ref={reviewHeadingRef} className="text-center mb-12" style={{ opacity: 0 }}>
            ...
            <p
              ...
              style={{ color: "rgba(0,0,0,0.45)", fontSize: "14px", lineHeight: 1.8 }}
            >
              Real photos from our 27 five-star Google reviews
            </p>
          </div>
