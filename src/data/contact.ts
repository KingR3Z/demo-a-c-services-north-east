...
export const contactHeroData = {
  ...
  text: "Whether you need a new driveway, patio, fencing, garden clearance or a full garden transformation — we're here to help. Call or text us to arrange a convenient time to visit.",
